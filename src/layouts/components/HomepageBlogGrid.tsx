...
const HomepageBlogGrid = ({ articles }: HomepageBlogGridProps) => {
  return (
    <div className="relative" suppressHydrationWarning={true}>
      ...
      {/* Articles Grid - 3 columns for homepage */}
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-10" suppressHydrationWarning={true}>
    ...
    <div className="group">
      <div className="relative overflow-hidden rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 bg-white dark:bg-darkmode-light transform hover:-translate-y-2">
        ...
        <div className="p-6 text-center">
          ...
          {/* Meta Information */}
          <div className="flex items-center justify-center text-sm text-gray-500 dark:text-darkmode-text-light mb-4">
          ...
          <div className="hidden md:block">
            ...
            >
              Read More
              <FaArrowRight className="w-4 h-4 ml-1 group-hover:translate-x-1 transition-transform duration-300" />
            </Link>
          </div>
        </div>
...
export default HomepageBlogGrid;
